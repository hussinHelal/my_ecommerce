...
$pro_sel = "SELECT * FROM products WHERE id='$id'";
$pro_res = $conn -> query($pro_sel);
$row = $pro_res -> fetch_assoc();
?>
<!--  Modal -->
              ...
              <div class="row align-items-stretch">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="p-5 my-md-4">
                    ...
                    <p class="text-muted">&dollar;<?=$row["price"]?></p>
                      ...
                      <div class="col-sm-7 pr-sm-0">
                        <div class="border d-flex align-items-center justify-content-between py-1 px-3"><span class="small text-uppercase text-gray mr-4 no-select">Quantity</span>
                          <div class="quantity">
                            ...
                            <input class="form-control border-0 shadow-0 p-0" type="text" value="<?=$row["count"]?>">
              ...
              <div class="card border-0 rounded-0 p-lg-4 bg-light">
                <div class="card-body">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="d-flex align-items-center justify-content-between"><strong class="small font-weight-bold"><?=$row["name"]?></strong><span class="text-muted small">$<?=$row["price"]?></span></li>
